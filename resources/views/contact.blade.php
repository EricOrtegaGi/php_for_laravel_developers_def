<x-layout title="{{ $title }}"  name="{{ $name }}" surname="{{ $surname }}">
    <div class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8"> <svg
        ...
        <div class="mx-auto max-w-xl lg:max-w-4xl">
            ...
            <p class="mt-2 text-lg leading-8 text-gray-600">Ajudem empreses i individuals a desenvolupar les seves
                directrius de marca.</p>
            <div class="mt-16 flex flex-col gap-16 sm:gap-y-20 lg:flex-row">
                <form action="#" method="POST" class="lg:flex-auto">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="last-name"
                                   class="block text-sm font-semibold leading-6 text-gray-900">Cognom</label>
                            <div class="mt-2.5">
                        ...
                        <div>
                            <label for="budget"
                                   class="block text-sm font-semibold leading-6 text-gray-900">Pressupost</label>
                            <div class="mt-2.5">
                        ...
                        <div>
                            <label for="website" class="block text-sm font-semibold leading-6 text-gray-900">Lloc
                                web</label>
                            <div class="mt-2.5">
                        ...
                        <div class="sm:col-span-2">
                            <label for="message"
                                   class="block text-sm font-semibold leading-6 text-gray-900">Missatge</label>
                            <div class="mt-2.5">
                    ...
                    <div class="mt-10">
                        <button type="submit"
                                class="block w-full rounded-md bg-blue-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Parlem</button>
                    </div>
                    <p class="mt-4 text-sm leading-6 text-gray-500">En enviar aquest formulari, accepto la <a href="#"
                                                                                                              class="font-semibold text-blue-600">política de privacitat</a>.</p>
                </form>
